...
from rxbpn.schedulers.timeoutscheduler import TimeoutScheduler


def observable_timer_date(duetime, scheduler: Optional[typing.Scheduler] = None) -> typing.Subscription:
...
def observable_timer_duetime_and_period(duetime, period, scheduler: Optional[typing.Scheduler] = None) \
        -> typing.Subscription:
    def subscribe(observer, scheduler_=None):
        _scheduler = scheduler or scheduler_
        if not hasattr(_scheduler, "schedule_periodic"):
...
def observable_timer_timespan(duetime: typing.RelativeTime, scheduler: Optional[typing.Scheduler] = None) \
        -> typing.Subscription:
    def subscribe(observer, scheduler_=None):
        _scheduler = scheduler or scheduler_
        if not hasattr(_scheduler, "schedule_periodic"):
